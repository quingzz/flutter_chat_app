...
class ChatRoom {
  ...
  factory ChatRoom.fromDB(Map<String, dynamic> data,
    ...
    return ChatRoom(roomName!, imgURL!, data['lastMess'] ?? 'No message');
  }
}
